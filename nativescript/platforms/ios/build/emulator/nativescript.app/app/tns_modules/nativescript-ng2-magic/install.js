...
function fixAngularPackage() {
    ...
    packageJSON.scripts["start.livesync.ios"] = "cd nativescript && tns livesync ios --emulator --watch && cd ..";
    packageJSON.scripts["start.android"] = "cd nativescript && tns emulate android && cd ..";
    packageJSON.scripts["start.livesync.android"] = "cd nativescript && tns livesync android --emulator --watch && cd ..";
